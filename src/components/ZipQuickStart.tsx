  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <h2 className="text-sm font-semibold uppercase tracking-[0.3em] text-slate-600">
        {t.zipQuickStart.label}
      </h2>
      <p className="text-xl font-semibold text-slate-900">
        {t.zipQuickStart.prompt}
      </p>
      <div className="flex gap-2">
        <input
          ...
          placeholder={t.zipQuickStart.placeholder}
        ...
        >
          {t.zipQuickStart.search}
          <span aria-hidden>&rarr;</span>
        </button>
      </div>
      <p className="text-xs text-slate-500">
        {t.zipQuickStart.privacy}
      </p>
    </form>

    <div className="mt-6 rounded-2xl border border-slate-200/70 bg-white/60 p-5">
      <h3 className="text-sm font-semibold text-slate-900">{t.zipQuickStart.noInsuranceTitle}</h3>
      <p className="mt-2 text-sm text-slate-600">
        {t.zipQuickStart.noInsuranceBody}
      </p>
    </div>
    </>
  );
