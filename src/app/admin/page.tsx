      ...
      <div className="rounded border bg-white p-4 mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-3">
          ...
          <input
            ...
            onBlur={async (e) => {
              const coords = await geocodeAddress(e.currentTarget.value);
              if (coords) setField("coords", coords);
            }}
          />
          <input
            className="border p-2 rounded md:col-span-2"
          ...
          <input
            ...
            value={form.coords[0]}
            onChange={(e) =>
              setField("coords", [Number(e.target.value) || 0, form.coords[1]])
            }
          />
          <input
            className="border p-2 rounded"
            ...
            value={form.coords[1]}
            onChange={(e) =>
              setField("coords", [form.coords[0], Number(e.target.value) || 0])
            }
          />
        </div>
